    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        <h2 className={classes.left}>
          <Link href="/">iProject</Link>
        </h2>
        <ul className={classes.right}>
          {session?.user ?
           (
            <div>
              <Image className={classes.resImg} onClick={handleShowDropdown} src={person} width='60' height='52'/>
              {
                showDropdown && (
           ...
           :
            (
              <>
              <button onClick={()=>{signIn()}} className={classes.login}>Login</button>
